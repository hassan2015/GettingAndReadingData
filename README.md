# GettingAndReadingData
Assignment for the course:
Assignment Info "From Assignment WebSite"
...
DATA in folder  UCIHARDataset
The dataset includes the following files:(From http://archive.ics.uci.edu/ml/machine-learning-databases/00240/UCI%20HAR%20Dataset.names)
=========================================
...
R code;
The code follow the steps as required by assignments, five steps in total.
1- Reading Data
2- Merger data
3- Use descriptive names
4- Lable data with one from 3
5- write a txt file
